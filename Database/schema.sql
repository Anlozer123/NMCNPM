...
CREATE TABLE [dbo].[ConsultationMessages](
    ...
    [RequestID] INT NOT NULL, -- Link tới phiên tư vấn
    [SenderID] INT NOT NULL,  -- ID người gửi
    [SenderType] NVARCHAR(20) NOT NULL CHECK ([SenderType] IN ('Patient', 'Doctor', 'Nurse')),
    [Content] NVARCHAR(MAX) NOT NULL,
    [SentAt] DATETIME NOT NULL DEFAULT GETDATE(),
    [UpdatedAt] DATETIME NULL,
    FOREIGN KEY ([RequestID]) REFERENCES [dbo].[ConsultationRequests]([RequestID])
);
-- =========================
-- 3. EXTEND PATIENT
-- =========================
