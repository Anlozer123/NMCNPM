...
router.post('/:patientId/nurse-request', patientController.sendNurseRequest);
router.get('/:patientId/nurse-request-history', patientController.getNurseRequestsHistory);
