...
const PatientProfile = () => {
    ...
    return (
        <div className="patient-profile-container">
            ...
            {/* PHẦN 1: TÓM TẮT (Chia 3 cột x 2 hàng) */}
            ...
            {/* --- DÒNG MỚI THÊM: 4 CHỨC NĂNG Ở GIỮA (Theo image_9498a6.png) --- */}
            <div className="profile-tabs">
                <button className="tab-item active">Thông tin cá nhân</button>
                <button className="tab-item">Kê đơn thuốc</button>
                <button className="tab-item">Chỉ thị điều dưỡng</button>
                <button className="tab-item">Hồ sơ bệnh án</button>
            </div>

            {/* PHẦN 2: THÔNG TIN CHI TIẾT (Chia 2 cột trái - phải) */}
